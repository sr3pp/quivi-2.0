...
UApp(tag="main")
  ...
  UButton(@click="openFaqs" label="FAQ's" color="primary" class="faq-btn")
  ...
  ClientOnly
    Cart
    NotificationStack
  Footer(:social="social" :distribuidores="distribuidores" @login-modal="loginHandler" @terms-modal="termsModalHandler")
</template>
