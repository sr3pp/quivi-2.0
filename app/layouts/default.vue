...
UApp(tag="main")
  ...
  a(
    ...
    target="_blank"
    class="fixed bottom-20 right-5 z-[1000] flex h-[3.75rem] w-[3.75rem] items-center justify-center rounded-[2.1875rem] bg-[#25d366] text-[1rem] text-[var(--color-white)] no-underline"
  )
